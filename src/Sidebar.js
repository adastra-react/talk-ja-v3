    ...
    return (<>
                ...
                >
                    ...
                    <div className="sidebar__header">
                        ...
                        <Avatar src={photoURL}/> <p className="sidebar__greeting mobile__tag"> <a href="/" style={{color:"white"}}>| MADE BY <span style={{color:"white"}}>KXNGLISH</span> |</a></p>
                    ...
                    <div className="sidebar__header">
                <Avatar src={photoURL}/> <p className="sidebar__greeting"> <a href="/">| MADE BY <span style={{color:"blue"}}>KXNGLISH</span> |</a></p>
                        <div className="sidebar__headerRight">
                            <IconButton>
                                <DonutLargeIcon />
                            </IconButton>
