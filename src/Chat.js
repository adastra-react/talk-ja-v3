                                        ...
                                        datewise.map((item,i)=>(
                                            ...
                                            <>
                                             {(parseInt(String(Object.keys(item)).slice(0,2)))?(<div className="chat__body__daystamp">
                                                ...
                                                >
                                                    <span className="chat__name">{e.name.substr(0,e.name.indexOf(' '))}</span>
                                                    ...
                                                    <span className="chat__timestamp">
                                                        ...
                                                        {  extramin= ((parseInt(
                                                            ...
                                                            ).slice(20, 22))+parseInt(GMTminutes))>60)?((parseInt(
                                                                String(
                                                                    new Date(e.timestamp?.toDate()).toUTCString()
                                                                ).slice(20, 22))+parseInt(GMTminutes))%60):(0)
                                                                }
                                                        
                                                        {  minutes= ((parseInt(
                                                            String(
                                                                new Date(e.timestamp?.toDate()).toUTCString()
                                                            ).slice(20, 22))+parseInt(GMTminutes)+extramin-fix)>60)?((parseInt(
                                                                String(
                                                                    new Date(e.timestamp?.toDate()).toUTCString()
                                                                ).slice(20, 22))+parseInt(GMTminutes)+extramin-fix)%60):((parseInt(
                                                                    String(
                                                                        new Date(e.timestamp?.toDate()).toUTCString()
                                                                    ).slice(20, 22))+parseInt(GMTminutes)+extramin-fix))
                                                                }
                                                                {
                                                                    hour=(extramin>0)?(1):(0)
                                                                }
                                                            
                                                            {hourly=((parseInt(String(
                                                                new Date(e.timestamp?.toDate()).toUTCString()
                                                            ).slice(17, 19))+hour+parseInt(clientGMT))>24)?((parseInt(String(
                                                                new Date(e.timestamp?.toDate()).toUTCString()
                                                            ).slice(17, 19))+hour+parseInt(clientGMT))%24):((parseInt(String(
                                                                new Date(e.timestamp?.toDate()).toUTCString()
                                                            ).slice(17, 19))+hour+parseInt(clientGMT)))}
                                                            </div>
                                                            {(hourly)?(hourly%12):("00")}{" : "}
                    ...
                    <div className="chat__footer__absolute">
                        ...
                        <form>
                            <input
                                ...
                                placeholder="Type a message"
                                onChange={(e) => setInput(e.target.value)}
                                disabled={(roomName=="Admin: Donald")?true:false}
                            />
                            <button type="submit" onClick={sendMessage}>
                                Send A message
              </button>
                                        ...
                                        datewise.map((item,i)=>(
                                            ...
                                            <>{(Object.keys(item) && Object.keys(item)!=undefined )?(
                                             <div className="chat__body__daystamp">
                                                ...
                                                >
                                                    <span className="chat__name">{e.name.substr(0,e.name.indexOf(' '))}</span>
                                                  <Linkify properties={{target: '_blank', style: {color: 'red', fontWeight: 'bold'}}}>{e.messageData}</Linkify>
                                                    <span className="chat__timestamp">
                                                        <div className="hidden">
                                                        {  extramin= ((parseInt(
                                                            String(
